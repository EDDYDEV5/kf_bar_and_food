      ...
      <div className=" h-full flex flex-col justify-center items-center">
            {items.map((item) => (
              ...
              >
                ...
                <div className=" px-4">
                  ...
                  <p className="py- font-semibold text-gray-900">₦{item.price}</p>
          ...
          <div className="flex items-center justify-center py-6">
            ...
            <button
              ...
              className="text-white font-semibold bg-lime-700 py-1 px-7 rounded-lg ring-2 border-4 ring-lime-700 hover:bg-transparent hover:text-indigo-950 hover:ring-4  "
            >
